...
class DashFinanzasHandler:
    ...
    def filtrar(self, trigger, tab, refresh_n_clicks, predios, fecha_inicio, fecha_fin, legacy_id, data, rutas,
        ...
        if (trigger["prop_id"] in ["refresh-button.n_clicks"]) or (tab == "todxs"):  # REVISAR
            ...
            if (not df_is_empty) and (
            not legacy_not_found):  # Si se cumplen las dos condiciones, muestra todo lo que tiene que mostrar
